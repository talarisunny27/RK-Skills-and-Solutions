                ...
                <div className="hidden md:flex flex-col flex-1 bg-[#1e253c] text-white p-12 justify-center relative overflow-hidden">
                    ...
                    <div className="relative z-10 max-w-sm pl-4">
                        ...
                        <p className="text-gray-300 text-sm leading-relaxed mt-4 w-5/6">
                            Learn, practice and track your progress. Sign in to continue your student portal.
                        </p>
                    </div>
                </div>
                        ...
                        <SignIn
                            ...
                            appearance={{
                                elements: {
                                    ...
                                    otpCodeField: 'flex justify-center w-full',
                                    otpCodeFieldInputs: 'flex justify-center gap-3 w-full',
                                    otpCodeFieldInput: 'w-12 h-12 text-center text-xl font-bold border border-gray-300 rounded-xl focus:border-[#cc5f6d] focus:ring-2 focus:ring-[#cc5f6d]/30'
                                }
                            }}
                        />
                    </div>
