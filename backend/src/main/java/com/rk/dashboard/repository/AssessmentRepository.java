...
public class AssessmentRepository {
    ...
    public List<AssessmentDTO> getAssessmentsForUser(String userId, String college) {
        return dsl.select(
                ...
                ASSESSMENTS.TITLE,
                ASSESSMENTS.TYPE,
                org.jooq.impl.DSL.field("module", String.class).as("module"),
                ASSESSMENTS.DATE,
    ...
    public AssessmentDTO createAssessment(Map<String, Object> body) {
        ...
        String module      = (String) body.getOrDefault("module", "Other");
        ...
        int id = dsl.insertInto(ASSESSMENTS,
                ASSESSMENTS.TITLE, ASSESSMENTS.TYPE, org.jooq.impl.DSL.field("module", String.class), ASSESSMENTS.DATE,
                ASSESSMENTS.DURATION, ASSESSMENTS.SCHEDULE,
                ASSESSMENTS.DESCRIPTION, ASSESSMENTS.COLLEGE)
            .values(title, type, module, date, duration, schedule, description, college)
            .returning(ASSESSMENTS.ID)
            .fetchOne()
            .get(ASSESSMENTS.ID);

        return new AssessmentDTO(id, title, type, module, date, duration, schedule, "Upcoming", "", description, college);
    }
    ...
    public int updateAssessment(int id, Map<String, Object> body) {
        ...
        var set = step
            ...
            .set(org.jooq.impl.DSL.field("module", String.class), (String) body.getOrDefault("module", "Other"))
