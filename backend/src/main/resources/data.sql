...
-- Insert assessments
INSERT INTO assessments (id, title, type, module, duration, schedule, description, college, date) 
VALUES 
(1, 'React Quiz', 'ASSESSMENT', 'Technical', 60, '10:00 AM - 11:00 AM', 'Advanced React concepts including Context and Hooks.', 'ALL', '2026-03-08'), 
(2, 'Next.js Practice', 'PRACTICE', 'Technical', 45, 'Anytime', 'Practice your basic Next.js routing skills.', 'KMIT', '2026-03-05'),
(3, 'Java Spring Boot Core', 'ASSESSMENT', 'Technical', 90, '09:00 AM - 10:30 AM', 'Core Spring Boot concepts, JPA, and REST APIs.', 'CBIT', '2026-03-15')
